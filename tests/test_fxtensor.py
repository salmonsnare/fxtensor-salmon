...
class TestSerialization:
    def test_json_serialization_deserialization(self):
        ...
        assert len(json_dict["strands"]) == 120
        assert len(json_dict["data"]) == 120
...
class TestSpecialTensors:
    ...
    def test_delta_tensor(self):
        ...
        delta_tensor = FXTensor.delta([2, 3])
        assert delta_tensor.profile == [[2, 3], [2, 3, 2, 3]]
        assert delta_tensor.data.shape == (2, 3, 2, 3, 2, 3)
